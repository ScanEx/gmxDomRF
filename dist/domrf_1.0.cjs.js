...
function create_if_block$1(ctx) {
	...
	binding_callbacks.push(() => bind(filters, "gmxMap", filters_gmxMap_binding));
	binding_callbacks.push(() => bind(filters, "leafletMap", filters_leafletMap_binding));
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!updating_gmxMap && dirty[0] & /*gmxMap*/ 2) {
				...
				filters_changes.gmxMap = /*gmxMap*/ ctx[1];
				add_flush_callback(() => updating_gmxMap = false);
			}

			if (!updating_leafletMap && dirty[0] & /*leafletMap*/ 1) {
				updating_leafletMap = true;
				filters_changes.leafletMap = /*leafletMap*/ ctx[0];
...
function create_fragment$1(ctx) {
	...
	let current;
	let dispose;
	let if_block = /*tab*/ ctx[2] === "filters" && create_if_block$1(ctx);
	...
	return {
		c() {
			...
			t1 = space();
			if (if_block) if_block.c();
			attr(a, "class", a_class_value = "nav-link " + (/*tab*/ ctx[2] === "filters" ? "active" : "-"));
			attr(a, "href", "#filters");
		...
		p(ctx, dirty) {
			if (!current || dirty[0] & /*tab*/ 4 && a_class_value !== (a_class_value = "nav-link " + (/*tab*/ ctx[2] === "filters" ? "active" : "-"))) {
				attr(a, "class", a_class_value);
			}

			if (/*tab*/ ctx[2] === "filters") {
				if (if_block) {
					if_block.p(ctx, dirty);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$set = $$props => {
		...
		if ("syncParams" in $$props) $$invalidate(5, syncParams = $$props.syncParams);
	};
	...
	return [
		...
		sidebar_visible,
		toggleBase,
		filters_gmxMap_binding,
		filters_leafletMap_binding,
